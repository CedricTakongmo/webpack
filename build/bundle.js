...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dao = __webpack_require__(119);
	...
	var Controller = function () {
	    ...
	    _createClass(Controller, [{
	        ...
	        key: "update",
	        value: function update(id, name, description) {
	            var item = new Model();
	            item.setId(id);
	            item.setName(name);
	            item.setDescription(description);
...
/***/ function(module, exports) {
	...
	var Model = function () {
	    ...
	    _createClass(Model, [{
	        ...
	        key: 'setDateCreation',
	        value: function setDateCreation(dateCreation) {
	            this.dateCreation = dateCreation;
	        }
	    }, {
	        key: 'getDateCreation',
	        value: function getDateCreation() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = function () {
	    ...
	    _createClass(View, [{
	        key: "render",
	        value: function render() {
	            this.$element = $(__webpack_require__(99)(this.getController()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"container\">\n    <div class=\"form-group\">\n        <label for=\"name\">Name:</label>\n        <input type=\"name\" class=\"form-control\" id=\"name\">\n    </div>\n    <div class=\"form-group\">\n        <label for=\"description\">Description: </label>\n        <input type=\"text\" class=\"form-control\" id=\"description\">\n    </div>\n    <button class=\"ctrl-create-dashboard btn btn-default\">Create</button>\n\n    <table class=\"table\">\n        <tr>\n            <td>Id</td>\n            <td>Name</td>\n            <td>Description</td>\n        </tr>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.dao : depth0)) != null ? stack1.database : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "    </table>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports) {
	...
	var Dao = function () {
	    ...
	    _createClass(Dao, [{
	        ...
	        key: "read",
	        value: function read(id) {
	            return this.database.find(function (item) {
	                return item.id === id;
	            });
	        }
	    }, {
	        ...
	        value: function update(item) {
	            var oldItem = this.database.find(function (i) {
	                return i.id === item.id;
	            });
	            if (oldItem != null) {
	        ...
	        value: function _delete(item) {
	            var toDelete = this.database.find(function (i) {
	                return i.id === item.id;
	            });
	            if (toDelete != null) {
